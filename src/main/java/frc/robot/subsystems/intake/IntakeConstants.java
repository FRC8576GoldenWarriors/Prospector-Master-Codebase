...
public class IntakeConstants {
    ...
    public class Software{
        public static double leftZero = -0.458;//-0.46;//-0.77+0.01-0.533+0.01-.518;//-0.29;//0.158-0.7;
        ...
        public static double kG = 0.15;//0.3;//0.6;//0.3;
        public static double kV = 0;
        public static double kA = 0;

        public static double intakeUp = 0.33;//0.33; //0.36;


        public static double intakeDown = 0.001;//0.09;//0.012;
        public static double agitatePosition =  .33;//0.25;//0.33;//0.22;

        public static double rollerSpeed = 0.7;
