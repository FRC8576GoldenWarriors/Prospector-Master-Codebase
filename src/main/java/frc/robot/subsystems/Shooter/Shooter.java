...
public class Shooter extends SubsystemBase {
  ...
  public boolean isRevved(){
    return MathUtil.isNear(wantedRPS.in(RotationsPerSecond),(inputs.leftMotorSpeed.in(RotationsPerSecond)+(inputs.rightMotorSpeed.in(RotationsPerSecond)))/2,4)||wantedRPS.in(RotationsPerSecond)+4<(inputs.rightMotorSpeed.in(RotationsPerSecond)+inputs.leftMotorSpeed.in(RotationsPerSecond))/2.0;//4//6//1
